<div class="flex flex-row mt-5 bg-indigo-800 w-full p-5 text-white">
    <div class="flex flex-col w-1/2">
        ...
        <div>
            ...
            <p class="mb-2"> 1300 861 455 </p>
            <p class="mb-2">hello@codinglabs.com.au</p>
        </div>
        <div class="flex flex-row mt-3">
            <a href="#" class=" hover:text-blue-300 dark:hover:text-white mr-2">
    ...
    <div class="flex flex-row w-1/2 justify-center">
        <div class="flex flex-col m-2">
            ...
            <h2 class="m-2">FAQS</h2>
        </div>

        <div class="flex flex-col m-2 mr-5">
