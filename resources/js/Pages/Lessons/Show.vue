...
<template>
    ...
    <div class="">
        <div id="unity-container" class="unity-desktop flex flex-col" >
            ...
            <div v-show="showChallengeWindow" >
            <form @submit.prevent="checkAnswer" class="mb-6 flex flex-col bg-zinc-500 p-3 ">
                ...
                <div v-show="resultWarning">
                    <div class="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                        <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20" ></svg>

                        <div>
                            <span class="font-medium">Attempt Incorrect</span> Change a few things up and try submitting again.
                        </div>
                    </div>
                </div>
                <textarea v-model="challengeUserAnswer" type="text" id="large-input" class="block  h-40 p-4 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
